...
ax[0].semilogx(omega1,mag1,color='r',label='System Without Time Delay',lw=2)
ax[0].semilogx(omega2,mag2,color='g',label='System With Time Delay',lw=2)
...
ax[1].semilogx(w,phase1,color='r',label='System Without Time Delay')
ax[1].semilogx(w,phase2,color='g',label='System With Time Delay')
